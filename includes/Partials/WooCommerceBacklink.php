...
class WooCommerceBacklink {
	...
	public static function add_back_link() {
		\wp_enqueue_script( 'nfd-ecommerce-woocommerce-captive', BLUEHOST_PLUGIN_URL . 'vendor/newfold-labs/wp-module-ecommerce/includes/Partials/woocommerce.js', [], '1', true);
