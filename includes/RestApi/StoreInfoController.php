...
class StoreInfoController extends \WC_REST_Data_Controller {
    ...
    public function get_item_schema() {
        return array(
            ...
            'properties' => array(
                ...
                'state'  => array(
                    'description' => __('Store state info.', 'woocommerce'),
                    'type'        => 'string',
                    'context'     => array('view', 'edit'),
                ),
                'country'  => array(
                    'description' => __('Store country info.', 'woocommerce'),
                    'type'        => 'string',
                    'context'     => array('view', 'edit'),
                ),
                'industry'  => array(
                    'description' => __('Store industry info.', 'woocommerce'),
                    'type'        => 'string',
                    'context'     => array('view', 'edit'),
                ),
            ),
    ...
    public function store_options( $request ) {
        ...
        foreach ( [ 'address', 'city', 'postcode' ] as $key ) {
            if ( ! isset( $params[ $key ] ) ) {
                continue;
            }
